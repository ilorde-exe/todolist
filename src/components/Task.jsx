...
const s = {
  ...
  text: `ml-2 cursor-pointer font-mono text-indigo-800`,
  textComplete: `ml-2 cursor-pointer line-through font-mono text-white`,
  ...
  return (
    <li className={task.completed ? s.liComplete : s.li}>
      ...
      <button onClick={() => deleteTask(task.id)}>
        <img className={s.trash} src="public/trash.png" alt="trash" />
      </button>
    </li>
  );
};
